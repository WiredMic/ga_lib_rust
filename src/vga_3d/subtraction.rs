...
forward_ref_binop!(impl Sub, sub for f32, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector,f32);
...
forward_ref_binop!(impl Sub, sub for f32, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for  VGA3DBivector, f32);
...
forward_ref_binop!(impl Sub, sub for f32, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, f32);
...
forward_ref_binop!(impl Sub, sub for f32, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, f32);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DBivector, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DVector, VGA3DRotor);
...
forward_ref_binop!(impl Sub, sub for VGA3DRotor, VGA3DVector);
...
forward_ref_binop!(impl Sub, sub for VGA3DBivector, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DBivector, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DBivector, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DBivector, VGA3DRotor);
...
forward_ref_binop!(impl Sub, sub for VGA3DRotor, VGA3DBivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DTrivector, VGA3DRotor);
...
forward_ref_binop!(impl Sub, sub for VGA3DRotor, VGA3DTrivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DRotor, VGA3DMultivector);
...
forward_ref_binop!(impl Sub, sub for VGA3DMultivector, VGA3DRotor);
